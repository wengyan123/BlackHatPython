...
def usage():
    ...
    print "-u --upload=destination : upon receiving connection upload a file and write to [destiontion]"
    print
    print
    print "Example: "
...
def main():
    ...
    if not listen and len(target) and port > 0:
        ...
        # this will block, so send CRTL-D if not sending input to stdin
